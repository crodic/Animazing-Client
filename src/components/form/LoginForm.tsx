...
const LoginForm = () => {
    return (
        <div className="z-20 w-full max-w-md space-y-8 px-4 sm:px-0 md:max-w-lg">
            <div className="relative">
                <Image src="/logo.png" width={100} height={100} alt="" className="rounded-full lg:hidden" />
                <div className="mt-5 space-y-2">
                    <h3 className="text-3xl font-semibold tracking-tighter sm:text-4xl">Sign in - Continue Journey</h3>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="z-20 space-y-5">
                <div>
                    <label className="font-geist font-medium">Email</label>
                    <Input
                        type="email"
                        required
                        className="mt-2 w-full rounded-lg border bg-transparent px-3 py-5 shadow-sm outline-none"
                    />
                </div>
                <div>
                    <label className="font-geist font-medium">Password</label>
                    <Input
                        type="password"
                        required
                        className="mt-2 w-full rounded-lg border bg-transparent px-3 py-5 shadow-sm outline-none"
                ...
                <div className="text-end text-primary hover:text-blue-500 hover:underline">
                ...
                <Link href="/" className="block text-center hover:text-blue-500 hover:underline">
                    Go To Home Page
                </Link>
            </form>
        </div>
